...
app accessibility/design/UX flow contracts, app evidence scenario SSOT,
accessibility/signing evidence template contracts, and the menubar smoke script contract.
