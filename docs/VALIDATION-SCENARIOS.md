...
| B9 | Local release artifact builds. | `scripts/release-smoke.sh`. |
...
`tmp/release-smoke` archive from release-mode SwiftPM products and inspects the archive
file list before any public release is cut.
