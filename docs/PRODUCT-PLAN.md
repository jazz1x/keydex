...
| M4 | In progress with SwiftUI shell, graph-derived inventory surfaces, accessibility contract, local screen evidence scenarios, and screen evidence review gate. |
