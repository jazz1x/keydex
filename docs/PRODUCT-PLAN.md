...
| M5 | In progress with local release smoke artifacts, unsigned app bundle and DMG evidence, and checksum evidence; signing and notarization remain incomplete. |
