...
| Settings scroll end | Settings screen evidence records `settings_scroll_target`; the long rules scenario captures the scrolled end with the 160 pt bottom scroll margin visible. |
