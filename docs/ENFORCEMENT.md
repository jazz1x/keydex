...
| App runtime accessibility smoke stays tied to supported scenarios | `scripts/app-evidence-scenarios-contract.sh` plus `scripts/app-accessibility-smoke.sh`; settings modal smoke also verifies hidden toolbar controls stay out of AX. |
