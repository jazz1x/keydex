...
expect_file_contains scripts/app-accessibility-evidence-status.sh "next_pending_screenshot"
expect_file_contains scripts/app-accessibility-evidence-status.sh "next_pending_review_command"
...
expect_file_contains docs/SCREEN-VALIDATION.md "next_pending_screenshot"
expect_file_contains docs/SCREEN-VALIDATION.md "next_pending_review_command"
expect_file_contains docs/VERIFICATION.md "next pending scenario/field/notes/screenshot/review-command set"
expect_file_contains docs/ENFORCEMENT.md "next pending review point, notes file, screenshot, review command"
...
expect_file_contains scripts/evidence-status.sh "app_accessibility_manual_next_pending_screenshot"
expect_file_contains scripts/evidence-status.sh "app_accessibility_manual_next_review_command"
...
expect_file_contains scripts/evidence-status.sh "release_signing_readiness_next_missing"
expect_file_contains scripts/evidence-status.sh "release_signing_readiness_next_action"
expect_file_contains scripts/evidence-status.sh "release_signing_readiness_runbook"
expect_file_contains scripts/evidence-status.sh "release_signing_readiness_next_command"
expect_file_contains scripts/evidence-status.sh "open docs/SIGNING-NOTARIZATION.md"
...
expect_file_contains docs/ENFORCEMENT.md "next missing Developer ID, notarytool, or stapler prerequisite"
expect_file_contains docs/VERIFICATION.md "next missing prerequisite, runbook path, and next command"
expect_file_contains docs/RELEASE-READINESS.md "release_signing_readiness_next_missing"
expect_file_contains docs/RELEASE-READINESS.md "release_signing_readiness_runbook"
expect_file_contains docs/RELEASE-READINESS.md "release_signing_readiness_next_command"
