...
expect_file_contains scripts/app-window-smoke.sh "width=1080 height=680"
...
expect_file_contains scripts/release-smoke.sh "known_limits=unsigned app bundle and unsigned DMG; signing/notarization remain future gates"
