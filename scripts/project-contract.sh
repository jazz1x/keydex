...
expect_file_contains docs/VERIFICATION.md "next pending scenario/field/notes/screenshot set"
expect_file_contains docs/ENFORCEMENT.md "next pending review point, notes file, screenshot"
