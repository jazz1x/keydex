...
expect_file_contains docs/RELEASE-READINESS.md "make release-signing-evidence-template ARGS=--force"
expect_file_contains docs/SIGNING-NOTARIZATION.md "make release-signing-evidence-template ARGS=--force"
