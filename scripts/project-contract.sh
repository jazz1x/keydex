...
expect_file_contains scripts/app-screen-evidence-review.sh "width=720 height=520"
expect_file_contains docs/SCREEN-VALIDATION.md "make app-screen-evidence-review"
expect_file_contains docs/SCREEN-VALIDATION.md "720 x 520 pt"
...
expect_file_contains Apps/KeydexApp/Sources/KeydexApp/KeydexApp.swift "EditableSettingsListSection"
expect_file_contains Apps/KeydexApp/Sources/KeydexApp/KeydexApp.swift "SettingsGlassSection"
expect_file_contains Apps/KeydexApp/Sources/KeydexApp/KeydexApp.swift 'ForEach($settings.scanSources)'
expect_file_contains Apps/KeydexApp/Sources/KeydexApp/KeydexApp.swift "Add scan path"
expect_file_contains docs/DESIGN-SYSTEM.md "Settings uses a material header plus grouped list sections"
