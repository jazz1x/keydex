...
expect_text docs/LOOP-CONTRACT.md "New automation must replace a repeated, observable failure"
expect_text docs/LOOP-CONTRACT.md "Prefer one narrow contract line over a new harness"
